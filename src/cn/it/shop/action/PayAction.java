...
/**
 * Struts处理流程： 1. 获取请求后，先创建Action代理，在创建代理的时候顺便创建了Action， 2.
 * 执行18个拦截器，拦截器执行成功后再调用Action的方法 3. Action的方法执行完毕后，再调用18个拦截器
...
public class PayAction extends BaseAction<Object> implements ParameterAware {
	...
	private static final long serialVersionUID = -5754984527763582995L;
